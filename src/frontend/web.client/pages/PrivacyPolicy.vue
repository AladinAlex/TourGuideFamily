    ...
    <div class="main-container max-width">
      ...
      <div class="privacy-policy__block-text">
        ...
        <p class="privacy-policy__text">
          ...
          договоров;<br />
          7.1.3. Предоставление доступа Пользователю к сервисам,
          информации и/или материалам, содержащимся на веб-сайте.<br />
          ...
          сообщений, направив Оператору письмо на Адрес электронной почты.<br />
